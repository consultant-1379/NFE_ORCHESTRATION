...
define('widgets/Notification/NotificationView',[
    ...
    return core.View.extend({
        ...
        getIcon: function () {
            return this.getElement().find('.ebNotification-icon');
        },

        getLabel: function () {
            return this.getElement().find('.ebNotification-label');
        },

        getCloseButton: function () {
            return this.getElement().find('.ebNotification-close');
        },

        hide: function () {
            this.getElement().setModifier('closed');
        },

        show: function () {
            this.getElement().removeModifier('closed');
        }
