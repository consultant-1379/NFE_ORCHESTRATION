...
define('jscore/ext/mvp',[
    ...
    function Collection(models, options) {
        ...
        var settings = _.extend({model: this.Model, _collection: this, parse: true}, options || {});
    ...
    Collection.prototype = {
        ...
        /**
         * parse is called whenever a collection's data is returned by the server in fetch, or is passed to the constructor. The function is passed the JSON data, the array of model attributes to be added to the collection, or in case of being called from constructor, it can also be JSON or an array of models. The default implementation simply returns its first argument. Override it to make any necessary changes to the data. This method should be avoided if possible. Be aware that any changes made to the data will also need to be reflected in object's <a href="https://developer.mozilla.org/en-US/docs/JSON#toJSON()_method">toJSON</a> method.
         *
         * @method parse
         * @param {Object} data
         * @return {Object} data
        ...
        /**
         * Performs a model search based on a string or regular expression match
         * with one or more model attributes. If second argument is provided, it will specify which attributes should be looked up for matches. Returns an new Collection with Models
         * If there was no match, information about the model is not included in
         * the results.
         *
         * @method  searchMap
